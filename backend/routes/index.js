...
router.use('/record-indexes', require('./record-indexes.routes'));
...
router.use('/watermark-templates', require('./watermark-templates.routes'));
...
router.use('/agent', require('./agentUpload.routes'));
