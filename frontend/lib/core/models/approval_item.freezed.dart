...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,approvalId,instanceId,stepId,documentId,recordNo,title,stepName,slaDays,startedAt,escalatedAt,requiresSignature);

@override
String toString() {
  return 'ApprovalItem(approvalId: $approvalId, instanceId: $instanceId, stepId: $stepId, documentId: $documentId, recordNo: $recordNo, title: $title, stepName: $stepName, slaDays: $slaDays, startedAt: $startedAt, escalatedAt: $escalatedAt, requiresSignature: $requiresSignature)';
}
...
/// Create a copy of ApprovalItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? approvalId = null,Object? instanceId = null,Object? stepId = null,Object? documentId = null,Object? recordNo = null,Object? title = null,Object? stepName = null,Object? slaDays = freezed,Object? startedAt = freezed,Object? escalatedAt = freezed,Object? requiresSignature = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'approval_id')  int approvalId, @JsonKey(name: 'instance_id')  int instanceId, @JsonKey(name: 'step_id')  int stepId, @JsonKey(name: 'document_id')  int documentId, @JsonKey(name: 'record_no')  String recordNo,  String title, @JsonKey(name: 'step_name')  String stepName, @JsonKey(name: 'sla_days')  int? slaDays, @JsonKey(name: 'started_at')  String? startedAt, @JsonKey(name: 'escalated_at')  String? escalatedAt, @JsonKey(name: 'requires_signature', fromJson: _boolFromInt)  bool requiresSignature)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ApprovalItem() when $default != null:
return $default(_that.approvalId,_that.instanceId,_that.stepId,_that.documentId,_that.recordNo,_that.title,_that.stepName,_that.slaDays,_that.startedAt,_that.escalatedAt,_that.requiresSignature);case _:
  return orElse();
...
/// Create a copy of ApprovalItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? approvalId = null,Object? instanceId = null,Object? stepId = null,Object? documentId = null,Object? recordNo = null,Object? title = null,Object? stepName = null,Object? slaDays = freezed,Object? startedAt = freezed,Object? escalatedAt = freezed,Object? requiresSignature = null,}) {
