...
import 'resources/api_keys_api.dart';
...
import 'resources/record_indexes_api.dart';
import 'resources/watermark_templates_api.dart';
...
import 'resources/report_templates_api.dart';
...
import 'resources/signature_api.dart';
...
final recordIndexesApiProvider = Provider<RecordIndexesApi>((ref) => RecordIndexesApi(ref.watch(apiClientProvider)));
final watermarkTemplatesApiProvider = Provider<WatermarkTemplatesApi>((ref) => WatermarkTemplatesApi(ref.watch(apiClientProvider)));
final reportsApiProvider = Provider<ReportsApi>((ref) => ReportsApi(ref.watch(apiClientProvider)));
final reportTemplatesApiProvider = Provider<ReportTemplatesApi>((ref) => ReportTemplatesApi(ref.watch(apiClientProvider)));
...
final signatureApiProvider = Provider<SignatureApi>((ref) => SignatureApi(ref.watch(apiClientProvider)));
